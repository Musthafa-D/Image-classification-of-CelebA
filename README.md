# Image Classification on CelebA (PyTorch)
...
- Over 200,000 face images
- 40 binary attribute labels (e.g., Smiling, Wearing_Hat, Eyeglasses)
- Large-scale face attribute dataset used for benchmarking
...
- Handling image transforms, resizing, normalization
